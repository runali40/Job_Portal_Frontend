                ...
                <div className="CreateOrdercontainer">
                    <div className="card">
                        ...
                        <div className="card--amount "><span className="currency">₹</span>
                            <input type="number" inputmode="decimal" className="card--dynamic-input" placeholder="0" style={{ width: "25px", maxlength: "1" }} /></div>
                        <textarea placeholder="Add a note" maxlength="100" className='text-center'></textarea>
                        <input className="card--pay-btn" type="button" value="Pay ₹0" disabled="" onClick={CreateOrderData} />
                    </div>
                    ...
                    ><div className="details-footer-top details-footer-top--center">
                            ...
                            <br /> Visit <a href="https://www.razorpay.com" target="_blank" rel="noopener noreferrer">razorpay.com</a> to get started!</div>
                        <img className="fin-logo" height="16px" width="281px" src="https://cdn.razorpay.com/static/assets/pay_methods_branding.png" alt="payment-methods" />
